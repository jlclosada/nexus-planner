...
-- CreateEnum
CREATE TYPE "TicketType" AS ENUM ('EPIC', 'STORY', 'TASK', 'BUG', 'SUBTASK', 'SPIKE');
...
-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('CREATED', 'STATUS_CHANGED', 'ASSIGNED', 'PRIORITY_CHANGED', 'SPRINT_CHANGED', 'COMMENT_ADDED', 'STORY_POINTS_CHANGED');
